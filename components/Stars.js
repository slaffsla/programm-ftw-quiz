      ...
      <View style={styles.container}>
        ...
        <View style={styles.smallStars}>
          <TouchableOpacity //#TODO: refactoring repeated code
            onPress={() =>
              navigation.navigate("Quiz", { lang: lang, difficulty: "NOOB" })
            }
          >
            <Image
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate("Quiz", { lang: lang, difficulty: "MIDDLE" })
            }
          >
            <Image
              style={styles.smallStar}
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate("Quiz", { lang: lang, difficulty: "SENIOR" })
            }
          >
            <Image
              style={styles.smallStar}
