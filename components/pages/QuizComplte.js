  ...
  return (
    <View>
      ...
      <View style={styles.container}>
        <Text style={styles.paragraph}>IT WAS PLEASURE ...</Text>
        <Image
        ...
        <ProgressBar
          style={{ marginTop: 0, height: 15, width: 270, marginLeft: 25 }}
          progress={0.3}
          color="#ff5800"
        />
        <View style={styles.timeView}>
          <Image
            style={styles.pinkClock}
            source={require("../../assets/icons/clock.png")}
          />
          <Text style={styles.paragraph}>02:01:0789 sec</Text>
        </View>
        <ProgressBar
          style={{ marginTop: 0, height: 15, width: 270, marginLeft: 25 }}
          progress={0.3}
